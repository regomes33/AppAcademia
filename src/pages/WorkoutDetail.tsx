...
import { workoutPlans, type Exercise } from "@/data/workouts";
...
import LogExerciseDialog from "@/components/LogExerciseDialog";
...
const WorkoutDetail = () => {
  ...
  const handleLogClick = (exercise: Exercise) => {
                    ...
                    {split.exercises.length > 0 ? (
                      <ul className="space-y-6 pl-4">
                        {split.exercises.map((exercise, index) => (
                          <li key={index} className="border-l-2 border-primary pl-4 space-y-3">
                            <div>
                            ...
                            <Button variant="secondary" size="sm" onClick={() => handleLogClick(exercise)}>
